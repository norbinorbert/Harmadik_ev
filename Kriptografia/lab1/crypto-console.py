...
def run_scytale():
    ...
    mode = input("Str or Bytes? ")
    while mode not in ['str', 'bytes']:
        mode = input("Str or Bytes? ")
    data = get_input(binary=(mode == 'bytes'))
    ...
    print("{}crypting {} using Scytale cipher and circumference {}...".format('En' if encrypting else 'De',
                                                                              data, circumference))
    if mode == 'str':
        output = (encrypt_scytale if encrypting else decrypt_scytale)(data, circumference, str)
    else:
        output = (encrypt_scytale if encrypting else decrypt_scytale)(data, circumference, bytes)

    set_output(output, binary=(mode == 'bytes'))
...
def run_railfence():
    ...
    print("{}crypting {} using Scytale cipher and num_rails {}...".format('En' if encrypting else 'De',
                                                                          data, num_rails))
